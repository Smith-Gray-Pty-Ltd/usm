...
<!-- USM:FACTS:START -->
> **Current release:** `v0.6.0` · **CLI commands:** `docs`, `enrich`, `feedback`, `generate`, `import`, `info`, `init`, `mcp`, `query`, `scaffold`, `scaffold-project`, `scan`, `upgrade`, `validate` · **MCP tools:** 18 (`usm_draft_feature`, `usm_get_contracts`, `usm_get_flows`, `usm_list`, `usm_query`, `usm_read`, `usm_references`, `usm_report_feedback`, `usm_search`, `usm_summary`, `usm_update_feature`, `usm_update_feature_status`, `usm_update_service`, `usm_update_system`, `usm_validate`, `usm_write_feature`, `usm_write_service`, `usm_write_system`)
>
