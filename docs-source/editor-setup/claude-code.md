...
Anthropic's CLI — claude mcp add one-liner + CLAUDE.md always-on rules
...
```bash
claude mcp add usm -- usm mcp serve
```
...
- **CLAUDE.md** — the detailed skill/workflow file
- **.claude/skills/usm-workflow/SKILL.md** — the always-on file (CLAUDE.md (committed to repo root))
