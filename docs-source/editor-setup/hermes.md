...
- **~/.hermes/skills/usm-workflow/SKILL.md** — the detailed skill/workflow file
- **~/.hermes/skills/usm-workflow/SKILL.md** — the always-on file (Loaded via hermes skills config in config.yaml)
