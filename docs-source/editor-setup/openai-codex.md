...
TOML at ~/.codex/config.toml + AGENTS.md rules
...
- **AGENTS.md** — the detailed skill/workflow file
- **AGENTS.md (committed to repo root)** — the always-on file (AGENTS.md — no per-message mechanism, loaded as project context)
